...
/*
 * Moteurs_LireEncodeurDroit
 *
 * LIT LE COMPTEUR TOTAL D'IMPULSIONS DE L'ENCODEUR DU MOTEUR DROIT
 * DEPUIS LA CARTE HIWONDER. COMPARE A CELUI DE GAUCHE APRES UN TRAJET
 * RECTILIGNE, IL REVELE SI LES DEUX MOTEURS TIENNENT REELLEMENT LA MEME
 * VITESSE OU SI L'UN D'EUX NE SUIT PAS SA CONSIGNE.
 *
 * PARAMETRE :
 * AUCUN
 *
