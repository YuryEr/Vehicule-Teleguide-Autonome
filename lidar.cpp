 ...
 *    6 Data-ready   --------->  (optionnel : voir note "trigger / pin 6" plus bas)
 *
 ...
 *
 *  REPERE / GEOMETRIE (identique a la version UART)
 *  -----------------------------------------------
...
void CentrerLidar(float vitesseDps = 200) { DeplaceServo(SERVO_CENTRE, vitesseDps); }
